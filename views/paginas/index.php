...
<section class="boletos">
    ...
    <div class="boletos__grid">
        <div class="boleto boleto--presencial" data-aos="fade-down" data-aos-offset="-900">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$199</p>
        </div>

        <div class="boleto boleto--virtual" data-aos="fade-left" data-aos-offset="-900">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$49</p>
        </div>

        <div class="boleto boleto--gratis" data-aos="fade-right" data-aos-offset="-900">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
